    ...
    if (isRedZone) {
      ...
      if (goals.referrals_this_week === 0 && memberCount >= 3) {
        suggestions.push({
          ...
          type: 'momentum',
          priority: 3,
          title: 'Mueve la primera ficha: refiere un contacto',
          description: 'Si tú mandas un cliente hoy, mañana te llega uno a ti. Así funciona: dar primero para recibir.',
