...
export const DynamicGreeting = ({ userName, consecutiveDays = 0 }: DynamicGreetingProps) => {
  ...
  return (
    <Card className="p-4 sm:p-6 bg-gradient-to-r from-primary/10 to-secondary/10 border-l-4 border-l-primary animate-in fade-in slide-in-from-top-4 duration-500">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg sm:text-2xl font-bold mb-2">{greeting}</h2>
          {consecutiveDays > 0 && (
